...
int main(int argc, char *argv[])
{
    ...
    int latticeSize = 70; //размер решетки latticeSize x latticeSize // 22 - 1012
    ...
    int nIntervals = 10000;//число интервалов энергий
    double stepOfInterval = (2 * abs(initialSystemEnergy)) / nIntervals;
    unsigned long long nIters = 10000; //размер окна (число Монте-Карло шагов / itersC)
    int itersC = 1;
    double T=0;
